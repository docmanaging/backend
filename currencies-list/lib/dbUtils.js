...
async function getCurrenciesList(requestParams,context) {
	...
	if (requestParams.userId){
		...
		if (results1.length < 1) 
		{
			...
			var readTable2 = "select currency_code,currency_name,decimals from CURRENCY_LIST_MASTER";
			...
			return {currenciesList: results2};
		}
